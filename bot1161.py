...
async def handle_start_command(message: types.Message):
    # Проверяем есть ли аргументы (deep link)
...
@dp.message(filters.Text(text=["Курьер", "Дроповод"]))
...
@dp.callback_query(filters.Text(startswith="approve_") | filters.Text(startswith="reject_"))
...
@dp.message(filters.Text(startswith="+выплата"))
